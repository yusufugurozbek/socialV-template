                                        ...
                                        <li>
                                            ...
                                            <Collapse in={open2}>
                                                <ul id="todotask2-collapse" to="#todotask2" className="sub-task  mt-2 p-0">
                                                    <li><Link to="#" className="d-flex align-items-center"><i className="material-symbols-outlined filled text-primary md-18 me-1">fiber_manual_record</i>All Task </Link></li>
                                                    <li><Link to="#" className="d-flex align-items-center"><i className="material-symbols-outlined filled text-warning md-18 me-1">fiber_manual_record</i> People </Link></li>
                                                    <li><Link to="#" className="d-flex align-items-center justify-content-between"><div className="d-flex align-items-center"><i className="material-symbols-outlined filled text-danger md-18 me-1">fiber_manual_record</i> Files </div><span className="badge bg-danger float-end">20</span> </Link></li>
                                                    <li><Link to="#" className="d-flex align-items-center"><i className="material-symbols-outlined filled text-primary md-18 me-1">fiber_manual_record</i> Statistics </Link></li>
                                                </ul>
                                            </Collapse>
                                        </li>
                                        <li>
                                            ...
                                            <li className="d-flex align-items-center p-3">
                                                <div className="user-img img-fluid">
                                                    ...
                                                    <div className="ms-3">
                                                        ...
                                                        <span className="badge bg-warning ms-1 ms-md-3 my-1 my-md-0 text-white">Expirinq</span>
                                            ...
                                            <li className="d-flex align-items-center p-3">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between w-100">
                                                    <div className="ms-3">
                                                        ...
                                                        <span className="badge bg-success ms-1 ms-md-3 my-1 my-md-0">Ending</span>
                                            ...
                                            <li className="d-flex align-items-center p-3">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between w-100">
                                                    <div className="ms-3">
                                                        ...
                                                        <span className="badge bg-danger ms-1 ms-md-3 my-1 my-md-0">Urgent</span>
