                    ...
                    <Row className="no-gutters">
                        <Col md="6" className="text-center pt-5">
                            <div className="sign-in-detail text-white">
                                <Link className="sign-in-logo mb-5" to="#"><Image src={logo} className="img-fluid"
                                                                                  alt="logo"/></Link>
                            ...
                            <div className="sign-in-from">
                                ...
                                <Form className="mt-4">
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Control type="email" className="mb-0" id="exampleInputEmail2"
                                    ...
                                    <div className="d-inline-block w-100">
                                        <Form.Check className="d-inline-block mt-2 pt-1">
                                            ...
                                            <Form.Check.Label>I accept <Link to="#">Terms and
                                                Conditions</Link></Form.Check.Label>
                                        </Form.Check>
                                        <Button type="button" className="btn-primary float-end"
                                                onClick={() => history.push('/')}>Sign Up</Button>
                                    </div>
                                    <div className="sign-info">
                                        <span
                                            className="dark-color d-inline-block line-height-2">Already Have Account ? <Link
                                            to="/auth/sign-in">Log In</Link></span>
                                            ...
                                            <li>
                                                <Link to="#">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18"
                                                        ...
                                                        <path
                                                            d="M15 16h-14c-0.553 0-1-0.447-1-1v-14c0-0.553 0.447-1 1-1h14c0.553 0 1 0.447 1 1v14c0 0.553-0.447 1-1 1zM14 2h-12v12h12v-12zM8 6c0-1.103 0.912-2 1.857-2h1.143v2h-1v1h1v2h-1v3h-2v-3h-1v-2h1v-1z"></path>
                                                    </svg>
                                                </Link>
                                            </li>
                                            <li>
