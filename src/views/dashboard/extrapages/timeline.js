                ...
                <Row className="justify-content-center">
                    ...
                    <Col lg="6">
                        ...
                        <div className="media-group">
                           <a href="#" className="iq-media"><Image src={img1} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           <a href="#" className="iq-media"><Image src={img2} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           <a href="#" className="iq-media"><Image src={img3} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           <a href="#" className="iq-media"><Image src={img4} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           <a href="#" className="iq-media"><Image src={img5} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           <a href="#" className="iq-media"><Image src={img6} className="img-fluid avatar-40 rounded-circle" alt="img" /></a>
                           </div>
                     </div>
                                    </li>
                                    <li>
